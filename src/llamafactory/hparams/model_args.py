...
class ModelArguments:
    ...
    rotate: bool = field(
        default=False,
        metadata={"help": "Rotate the residual activation in the moodel."},
    )
    rotate_down_proj: bool = field(
        default=False,
        metadata={"help": "Rotate the down projection in the moodel."},
    )
    fp32_had: bool = field(
        default=False,
        metadata={"help": "Whether to perform the hadamard in FP32"},
    )
    qlora_4bit_rotate: bool = field(
        default=False,
        metadata={"help": "Whether to perform rotate 4bit-qlora on rotated model"},
    )
    rotate_mode: Literal['hadamard', 'random'] = field(
        default="hadamard",
        metadata={"help": "The type for rotation."},
    )
